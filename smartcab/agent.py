...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        maxQ_actions = [action for action in possible_actions.keys() if possible_actions[action] == maxQ]
...
def run():
    ...
    # Flags:
    verbose = False  #  - set to True to display additional output from the simulation
    ...
    alpha = 0.2  # continuous value for the learning rate, default is 0.5
    agent = env.create_agent(LearningAgent, learning=learning, epsilon=epsilon, alpha=alpha)
    ...
    # Run the simulator
    # Flags:
    tolerance = 0.05 # epsilon tolerance before beginning testing, default is 0.05 
    n_test = 100 #     - discrete number of testing trials to perform, default is 0
